...
namespace ROEngines
{
    ...
    public class ROEDeployableEngine : PartModule
    {
        ...
        public void Start()
        {
            ...
            {
                MonoBehaviour.print("ERROR: Could not locate engine by ID: " + engineID + " for part: " + part + " for ROEDeployableEngine.  This will cause errors during gameplay.  Setting engine to first engine module (if present)");                
            }
